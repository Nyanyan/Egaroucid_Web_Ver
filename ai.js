...
assert(INITIAL_MEMORY == 78643200, 'Detected runtime INITIAL_MEMORY setting.  Use -s IMPORTED_MEMORY to define wasmMemory dynamically');
...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    //assert(wasmMemory.buffer.byteLength === 78643200);
...
/** @type {function(...*):?} */
var _init_ai = Module["_init_ai"] = createExportWrapper("init_ai");

/** @type {function(...*):?} */
var _ai = Module["_ai"] = createExportWrapper("ai");
